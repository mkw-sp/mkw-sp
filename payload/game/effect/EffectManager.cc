...
void EffectManager::initRace() {
    ...
    auto *breff = resourceManager->getFile(System::ResourceType::Race, "RKRace_SP.breff", nullptr);
    auto *breft = resourceManager->getFile(System::ResourceType::Race, "RKRace_SP.breft", nullptr);
