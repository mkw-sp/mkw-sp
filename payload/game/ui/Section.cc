...
void Section::addPages(SectionId id) {
    ...
    std::pair<SectionId, PageId> additions[] = {
            ...
            {SectionId::Single, PageId::CourseSelect},
            {SectionId::SingleChangeDriver, PageId::CourseSelect},
            {SectionId::SingleChangeCourse, PageId::CourseSelect},
            {SectionId::SingleChangeGhostData, PageId::CourseSelect},
            {SectionId::Multi, PageId::CourseSelect},
            ...
            // LEGACY PAGES BLOB
            {SectionId::GhostTAOnline, PageId::OnlineConnectionManager},
            {SectionId::LicenseSettings, PageId::MenuSettings},
            {SectionId::LicenseSettings, PageId::SettingsPopup},
            {SectionId::LicenseSettings, PageId::ServicePackChannel},
            {SectionId::Single, PageId::CourseSelect},
            {SectionId::SingleChangeDriver, PageId::CourseSelect},
            {SectionId::SingleChangeCourse, PageId::CourseSelect},
            {SectionId::SingleChangeMission, PageId::CourseSelect},
            {SectionId::SingleSelectVSCourse, PageId::CourseSelect},
            {SectionId::Multi, PageId::CourseSelect},
            {SectionId::OnlineSingle, PageId::DirectConnection},
            {SectionId::OnlineSingle, PageId::OnlineConnectionManager},
            {SectionId::OnlineSingle, PageId::OnlineTop},
            {SectionId::OnlineSingle, PageId::RandomMatching},
            {SectionId::OnlineSingle, PageId::FriendMatching},
            {SectionId::OnlineSingle, PageId::FriendRoomBack},
            {SectionId::WifiSingleDisconnected, PageId::DirectConnection},
            {SectionId::WifiSingleDisconnected, PageId::OnlineConnectionManager},
            {SectionId::WifiSingleDisconnected, PageId::OnlineTop},
            {SectionId::WifiSingleDisconnected, PageId::RandomMatching},
            {SectionId::WifiSingleDisconnected, PageId::FriendMatching},
            {SectionId::WifiSingleDisconnected, PageId::FriendRoomBack},
            {SectionId::WifiSingleFriendList, PageId::DirectConnection},
            {SectionId::WifiSingleFriendList, PageId::OnlineConnectionManager},
            {SectionId::WifiSingleFriendList, PageId::OnlineTop},
            {SectionId::WifiSingleFriendList, PageId::RandomMatching},
            {SectionId::WifiSingleFriendList, PageId::FriendMatching},
            {SectionId::WifiSingleFriendList, PageId::FriendRoomBack},
            {SectionId::WifiSingleVsVoting, PageId::CourseSelect},
            {SectionId::WifiSingleVsVoting, PageId::OnlineConnectionManager},
            {SectionId::WifiSingleVsVoting, PageId::VotingBack},
            {SectionId::WifiMultiVsVoting, PageId::CourseSelect},
            {SectionId::WifiMultiVsVoting, PageId::OnlineConnectionManager},
            {SectionId::WifiMultiVsVoting, PageId::VotingBack},
            {SectionId::Voting1PVS, PageId::CourseSelect},
            {SectionId::Voting1PVS, PageId::OnlineConnectionManager},
            {SectionId::Voting1PVS, PageId::VotingBack},
            {SectionId::Voting1PTeamVS, PageId::CourseSelect},
            {SectionId::Voting1PTeamVS, PageId::OnlineConnectionManager},
            {SectionId::Voting1PTeamVS, PageId::VotingBack},
            {SectionId::Voting2PVS, PageId::CourseSelect},
            {SectionId::Voting2PVS, PageId::OnlineConnectionManager},
            {SectionId::Voting2PVS, PageId::VotingBack},
            {SectionId::Voting2PTeamVS, PageId::CourseSelect},
            {SectionId::Voting2PTeamVS, PageId::OnlineConnectionManager},
            {SectionId::Voting2PTeamVS, PageId::VotingBack},
            {SectionId::WifiSingleBtVoting, PageId::OnlineConnectionManager},
            {SectionId::WifiSingleBtVoting, PageId::VotingBack},
            {SectionId::WifiMultiBtVoting, PageId::OnlineConnectionManager},
            {SectionId::WifiMultiBtVoting, PageId::VotingBack},
            {SectionId::Voting1PBalloon, PageId::OnlineConnectionManager},
            {SectionId::Voting1PBalloon, PageId::VotingBack},
            {SectionId::Voting1PCoin, PageId::OnlineConnectionManager},
            {SectionId::Voting1PCoin, PageId::VotingBack},
            {SectionId::Voting2PBalloon, PageId::OnlineConnectionManager},
            {SectionId::Voting2PBalloon, PageId::VotingBack},
            {SectionId::Voting2PCoin, PageId::OnlineConnectionManager},
            {SectionId::Voting2PCoin, PageId::VotingBack},
            {SectionId::OnlineMulti, PageId::DirectConnection},
            {SectionId::OnlineMulti, PageId::OnlineConnectionManager},
            {SectionId::OnlineMulti, PageId::OnlineTop},
            {SectionId::OnlineMulti, PageId::RandomMatching},
            {SectionId::OnlineMulti, PageId::FriendMatching},
            {SectionId::OnlineMulti, PageId::FriendRoomBack},
            {SectionId::WifiMultiDisconnected, PageId::DirectConnection},
            {SectionId::WifiMultiDisconnected, PageId::OnlineConnectionManager},
            {SectionId::WifiMultiDisconnected, PageId::OnlineTop},
            {SectionId::WifiMultiDisconnected, PageId::RandomMatching},
            {SectionId::WifiMultiDisconnected, PageId::FriendMatching},
            {SectionId::WifiMultiDisconnected, PageId::FriendRoomBack},
            {SectionId::WifiMultiFriendList, PageId::DirectConnection},
            {SectionId::WifiMultiFriendList, PageId::OnlineConnectionManager},
            {SectionId::WifiMultiFriendList, PageId::OnlineTop},
            {SectionId::WifiMultiFriendList, PageId::RandomMatching},
            {SectionId::WifiMultiFriendList, PageId::FriendMatching},
            {SectionId::WifiMultiFriendList, PageId::FriendRoomBack},
            {SectionId::WifiVS, PageId::OnlineConnectionManager},
            {SectionId::WifiMultiVS, PageId::OnlineConnectionManager},
            {SectionId::WifiVSSpectate, PageId::OnlineConnectionManager},
            {SectionId::WifiVSMultiSpectate, PageId::OnlineConnectionManager},
            {SectionId::WifiBT, PageId::OnlineConnectionManager},
            {SectionId::WifiMultiBT, PageId::OnlineConnectionManager},
            {SectionId::WifiBTSpectate, PageId::OnlineConnectionManager},
            {SectionId::WifiBTMultiSpectate, PageId::OnlineConnectionManager},
            {SectionId::OnlineFriend1PVS, PageId::OnlineConnectionManager},
            {SectionId::OnlineFriend1PTeamVS, PageId::OnlineConnectionManager},
            {SectionId::OnlineFriend1PBalloon, PageId::OnlineConnectionManager},
            {SectionId::OnlineFriend1PCoin, PageId::OnlineConnectionManager},
            {SectionId::OnlineFriend2PVS, PageId::OnlineConnectionManager},
            {SectionId::OnlineFriend2PTeamVS, PageId::OnlineConnectionManager},
            {SectionId::OnlineFriend2PBalloon, PageId::OnlineConnectionManager},
            {SectionId::OnlineFriend2PCoin, PageId::OnlineConnectionManager},
            {SectionId::ServicePack, PageId::ServicePackTop},
            {SectionId::ServicePack, PageId::StorageBenchmark},
            {SectionId::ServicePack, PageId::ServicePackTools},
            {SectionId::ServicePackChannel, PageId::ServicePackTop},
            {SectionId::ServicePackChannel, PageId::StorageBenchmark},
            {SectionId::ServicePackChannel, PageId::ServicePackTools},
            {(SectionId)0x7C, PageId::ServicePackTop},
            {(SectionId)0x7C, PageId::StorageBenchmark},
            {(SectionId)0x7C, PageId::ServicePackTools},
            {SectionId::Rankings, PageId::CourseSelect},
            {SectionId::Rankings, PageId::DirectConnection},
            {SectionId::Rankings, PageId::OnlineConnectionManager},
            {(SectionId)0x7E, PageId::DirectConnection},
            {(SectionId)0x7E, PageId::OnlineConnectionManager},
            {(SectionId)0x80, PageId::DirectConnection},
            {(SectionId)0x80, PageId::OnlineConnectionManager},
            {(SectionId)0x81, PageId::DirectConnection},
            {(SectionId)0x81, PageId::OnlineConnectionManager},
            {(SectionId)0x83, PageId::DirectConnection},
            {(SectionId)0x83, PageId::OnlineConnectionManager},
            {(SectionId)0x83, PageId::OnlineTeamSelect},
            {(SectionId)0x83, PageId::RandomMatching},
            {(SectionId)0x83, PageId::FriendMatching},
            {(SectionId)0x83, PageId::FriendRoomBack},
            {(SectionId)0x84, PageId::DirectConnection},
            {(SectionId)0x84, PageId::OnlineConnectionManager},
            {(SectionId)0x84, PageId::OnlineTeamSelect},
            {(SectionId)0x84, PageId::RandomMatching},
            {(SectionId)0x84, PageId::FriendRoomRules},
            {(SectionId)0x84, PageId::FriendMatching},
            {(SectionId)0x84, PageId::FriendRoomBack},
            {SectionId::CompetitionSubmitRecord, PageId::DirectConnection},
            {SectionId::CompetitionSubmitRecord, PageId::OnlineConnectionManager},
            {SectionId::Options, PageId::Channel},
            {SectionId::Options, PageId::Update},
            {SectionId::AddMkChannel, PageId::Channel},
            {SectionId::AddMkChannel, PageId::Update},
    };
