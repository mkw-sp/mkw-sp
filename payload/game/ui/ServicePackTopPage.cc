...
void ServicePackTopPage::onInit() {
    ...
    m_storageBenchmarkButton.load("button", "StorageBenchmarkButton", "Option", 0x1, false, false);
...
void ServicePackTopPage::onStorageBenchmarkButtonFront([[maybe_unused]] PushButton *button,
