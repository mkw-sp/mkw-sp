...
code_in_files = {
    'payload': [
        *protobuf_c_files,
        ...
        os.path.join('payload', 'game', 'enemy', 'EnemyManager.cc'),
        ...
        os.path.join('payload', 'game', 'item', 'ItemManager.cc'),
        ...
        os.path.join('payload', 'game', 'item', 'KartItem.cc'),
        ...
        os.path.join('payload', 'game', 'kart', 'KartRollback.cc'),
        ...
        os.path.join('payload', 'game', 'kart', 'KartSub.cc'),
        ...
        os.path.join('payload', 'game', 'race', 'BoxColManager.cc'),
        ...
        os.path.join('payload', 'game', 'scene', 'RaceScene.cc'),
        ...
        os.path.join('payload', 'game', 'system', 'MultiDvdArchive.cc'),
        ...
        os.path.join('payload', 'game', 'system', 'RaceMode.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'ArgumentParser.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'LicenseControl.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'OnlineConnectionManagerPage.cc'),
        os.path.join('payload', 'game', 'ui', 'OnlineModeSelectPage.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'TitlePage.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRaceBattleAddPoint.cc'),
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRaceBattlePoint.cc'),
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRaceBattleTotalPoint.cc'),
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRaceDebugPanel.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRaceWaitSymbol.cc'),
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRaceWifiFinishMessage.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'page', 'ReplayGhostRaceMenuPage.cc'),
        os.path.join('payload', 'game', 'ui', 'page', 'ResultCompetitionPage.cc'),
        os.path.join('payload', 'game', 'ui', 'page', 'ResultPlayerPage.cc'),
        os.path.join('payload', 'game', 'ui', 'page', 'ResultTeamPage.cc'),
        os.path.join('payload', 'game', 'ui', 'page', 'ResultTeamTotalPage.cc'),
        os.path.join('payload', 'game', 'ui', 'page', 'TaRaceMenuPage.cc'),
        os.path.join('payload', 'game', 'ui', 'page', 'TimeAttackSplitsPage.S'),
        os.path.join('payload', 'game', 'ui', 'page', 'TimeAttackSplitsPage.cc'),
        os.path.join('payload', 'game', 'ui', 'page', 'ToRaceMenuPage.cc'),
        os.path.join('payload', 'game', 'ui', 'page', 'TopMenuPage.S'),
        os.path.join('payload', 'game', 'ui', 'page', 'TopMenuPage.c'),
        os.path.join('payload', 'game', 'ui', 'page', 'TopMenuPage.cc'),
        os.path.join('payload', 'game', 'ui', 'page', 'VsRaceMenuPage.cc'),
        ...
        os.path.join('payload', 'sp', 'Commands.cc'),
        ...
        os.path.join('payload', 'sp', 'ItemCommand.c'),
        ...
        os.path.join('payload', 'sp', 'settings', 'FileReplacement.cc'),
        os.path.join('payload', 'sp', 'settings', 'GlobalSettings.cc'),
