...
asset_in_files = {
    ...
    os.path.join('Scene', 'UI', 'GlobeSP.arc.lzma'): [
        ...
        # Teams
        os.path.join('control', 'ctrl', 'OnlineTeamUpDownBase.brctr.json5'),
        os.path.join('ranking', 'blyt', 'online_team_select_window.brlyt.json5'),
        os.path.join('ranking', 'blyt', 'online_team_select_window_text.brlyt.json5'),
        os.path.join('control', 'ctrl', 'OnlineTeamUpDownButtonL.brctr.json5'),
        os.path.join('control', 'ctrl', 'OnlineTeamUpDownButtonR.brctr.json5'),
        os.path.join('ranking', 'ctrl', 'OnlineTeamUpDownText.brctr.json5'),
        os.path.join('ranking', 'ctrl', 'OnlineTeamUpDownValue.brctr.json5'),
    ],
