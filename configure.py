...
asset_in_files = {
    ...
    os.path.join('Scene', 'UI', 'GlobeSP.arc.lzma'): [
        ...
        # Teams
        os.path.join('button', 'anim', 'team_box_position.brlan.json5'),
        os.path.join('button', 'blyt', 'team_box.brlyt.json5'),
        os.path.join('button', 'ctrl', 'TeamBox.brctr.json5'),
    ],
...
code_in_files = {
    'payload': [
        *protobuf_c_files,
        ...
        os.path.join('payload', 'game', 'ui', 'TeamBoxControl.cc'),
