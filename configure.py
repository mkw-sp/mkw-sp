...
asset_in_files = {
    ...
    'OthrSP.szs': [
        ...
        os.path.join('control', 'blyt', 'InputDisplay.brlyt.json5'),
        ...
        os.path.join('control', 'timg', 'accel_off.tpl'),
        os.path.join('control', 'timg', 'accel_on.tpl'),
        os.path.join('control', 'timg', 'cstick_bg.tpl'),
        os.path.join('control', 'timg', 'cstick_center.tpl'),
        os.path.join('control', 'timg', 'dpad_down.tpl'),
        os.path.join('control', 'timg', 'dpad_left.tpl'),
        os.path.join('control', 'timg', 'dpad_off.tpl'),
        os.path.join('control', 'timg', 'dpad_right.tpl'),
        os.path.join('control', 'timg', 'dpad_up.tpl'),
        os.path.join('control', 'timg', 'trigger_off.tpl'),
        os.path.join('control', 'timg', 'trigger_on.tpl'),
