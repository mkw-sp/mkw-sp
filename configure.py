...
code_in_files = {
    'payload': [
        ...
        os.path.join('payload', 'game', 'ui', 'CourseDetailPage.c'),
...
asset_in_files = {
    ...
    os.path.join('Scene', 'UI', 'MenuSingleSP.szs'): [
        os.path.join('bg', 'blyt', 'course_select_background.brlyt.json5'),
        os.path.join('bg', 'blyt', 'obi_bottom.brlyt.json5'),
        os.path.join('bg', 'blyt', 'obi_top.brlyt.json5'),
        os.path.join('bg', 'ctrl', 'CourseSelectBackground.brctr.json5'),
        os.path.join('bg', 'timg', 'empty.tpl'),
        ...
        os.path.join('button', 'ctrl', 'CourseSelectOption.brctr.json5'),
